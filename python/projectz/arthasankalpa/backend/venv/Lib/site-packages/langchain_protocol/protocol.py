...
class PlainTextContentBlock(TypedDict):
    ...
    text: NotRequired[str]  # Inline plaintext (optional if base64 is provided)
...
DataContentBlock = Union[ImageContentBlock, VideoContentBlock, AudioContentBlock, PlainTextContentBlock, FileContentBlock]
...
class MessageStartData(TypedDict):
    ...
    message_id: NotRequired[str]  # Unique ID for this message
